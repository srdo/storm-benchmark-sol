...
public class IncDouble1 extends StormBenchmark {
...
//  public static final String BOLT_NUM = "component.bolt_num";
  ...
  public static final String BOLT_ID3 = "bolt3";
...
//    final int boltNum = BenchmarkUtils.getInt(config, BOLT_NUM, DEFAULT_BOLT_NUM);
    ...
    // setup bolts
    builder.setBolt(BOLT_ID1, new IncrementBolt(), 1)
            .localOrShuffleGrouping(SPOUT_ID);
    builder.setBolt(BOLT_ID2, new DoublerBolt(), 1)
            .localOrShuffleGrouping(BOLT_ID1);
    builder.setBolt(BOLT_ID3, new IncrementBolt(), 1)
            .localOrShuffleGrouping(BOLT_ID2);
  ...
  public static class IncrementBolt extends BaseRichBolt {
  ...
  public static class DoublerBolt extends BaseRichBolt {
    private static final long serialVersionUID = -5313598399155365865L;
    public static final String FIELDS = "number";
    private OutputCollector collector;
    ...
    public void execute(Tuple tuple) {
      Long val = (Long) tuple.getValue(0);
      collector.emit(new Values(val*2));
      collector.ack(tuple);
    }
